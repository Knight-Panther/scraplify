...
- Whether the `Ratelimit-Policy: 20;w=60` bucket observed on `robots.txt` also governs SSR page responses (those responses did not carry the headers). The policy takes the conservative reading.
