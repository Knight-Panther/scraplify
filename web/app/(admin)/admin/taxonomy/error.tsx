...
/**
 * This route's own error state, following `(local)/taxonomy-review/error.tsx`'s
 * template — `retry`, not `reset`: `reset()` re-renders the boundary's
 * children without re-fetching, so against a server-component database
 * failure the button would appear to work and change nothing.
 *
