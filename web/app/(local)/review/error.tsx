...
/**
 * The review screen's own error state, following the shortlist's template
 * (`web/app/(local)/saved/error.tsx`) exactly, including the `retry`-not-`reset`
 * reasoning: `reset()` re-renders the boundary's children without
 * re-fetching, which against a server-component database failure would
