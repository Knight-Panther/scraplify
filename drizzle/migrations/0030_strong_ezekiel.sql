...
ALTER TABLE "source_policies" DROP COLUMN "revision_seq";--> statement-breakpoint
ALTER TABLE "source_policies" ADD CONSTRAINT "source_policies_source_id_unique" UNIQUE("source_id");--> statement-breakpoint
CREATE VIEW "public"."public_opportunity_members" AS (
  ...
  left join "source_policies" on "source_policies"."source_id" = "sources"."id"
