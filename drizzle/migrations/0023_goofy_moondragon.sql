CREATE VIEW "public"."public_opportunities" AS (
  select
    ...
    "opportunities"."canonical_title" as canonical_title,
    "opportunities"."canonical_status" as canonical_status,
    "opportunities"."type" as type,
    "opportunities"."created_at" as created_at,
    "opportunities"."updated_at" as updated_at
  from "opportunities"
  where "opportunities"."canonical_status" <> 'quarantined'
...
CREATE VIEW "public"."public_opportunity_members" AS (
  select
    ...
    "source_listing_revisions"."description" as description,
