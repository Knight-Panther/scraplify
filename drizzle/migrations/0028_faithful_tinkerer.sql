...
ALTER TABLE "source_policies" ADD COLUMN "created_at" timestamp with time zone DEFAULT now() NOT NULL;--> statement-breakpoint
CREATE VIEW "public"."public_opportunity_members" AS (
  ...
  left join lateral (
    ...
    order by "source_policies"."review_date" desc, "source_policies"."created_at" desc, "source_policies"."id" desc
    limit 1
